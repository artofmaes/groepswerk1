...
$sql = 'select afb_id, afb_naam, afb_user_id, afb_date, afb_omschr, afb_bestand, user_username, tag_omschr
from afbeelding
...
?>
    ...
    <img src="img/<?php echo $afb_bestand ?>" alt="image with caption: <?php echo $afb_naam ?>">
